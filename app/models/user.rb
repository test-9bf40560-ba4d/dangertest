...
class User < ApplicationRecord
  ...
  def max_changeset_comments_per_hour
    if moderator?
      ...
      previous_comments = changeset_comments.limit(Settings.changeset_comments_for_rate_limit).count
      max_comments = previous_comments / Settings.changeset_comments_for_rate_limit.to_f * Settings.max_changeset_comments_per_hour
